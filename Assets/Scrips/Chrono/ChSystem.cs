...
public class ChSystem : ChIntegrableIIorder {
  ...
  public virtual void SetCollisionSystem(ChCollisionSystem newcollsystem) {
    corePINVOKE.ChSystem_SetCollisionSystem(swigCPtr, ChCollisionSystem.getCPtr(newcollsystem));
    if (corePINVOKE.SWIGPendingException.Pending) throw corePINVOKE.SWIGPendingException.Retrieve();
  }
